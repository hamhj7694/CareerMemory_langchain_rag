...
export function ExperienceProposalModal({
  ...
  return (
    <div className="mv2-modal-backdrop mv2-experience-preview-backdrop">
      <section className="mv2-experience-preview-modal" role="dialog" aria-modal="true" aria-label="경험 구조화 제안">
        <header>
          <div><span className="mv2-kicker">EXPERIENCE AI</span><h2>경험 구조화 제안</h2><p>경험 분류와 프로젝트·활동을 확인한 뒤 상세 작성으로 넘어가세요.</p></div>
